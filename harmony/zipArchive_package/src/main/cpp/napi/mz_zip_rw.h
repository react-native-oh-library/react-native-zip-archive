...
#ifndef MYAPPLICATION_MZ_ZIP_RW_H
#define MYAPPLICATION_MZ_ZIP_RW_H
...
typedef int32_t (*mz_zip_reader_progress_cb)(void *handle, void *userdata, mz_zip_file *file_info, int64_t position,
                                             float &fprogress, int &uncompressedSize);
typedef int32_t (*mz_zip_reader_entry_cb)(void *handle, void *userdata, mz_zip_file *file_info, const char *path);

typedef void (*funcProgressCallback)(float refProgress, int uncompressedSize);

typedef void (*funcProgressCallbackzip)(float refProgress);
/***************************************************************************/
...
typedef int32_t (*mz_zip_writer_password_cb)(void *handle, void *userdata, mz_zip_file *file_info, char *password,
                                             int32_t max_password);
typedef int32_t (*mz_zip_writer_progress_cb)(void *handle, void *userdata, mz_zip_file *file_info, int64_t position, float &fprogress);
...
void mz_zip_writer_set_progress_cb(void *handle, void *userdata, mz_zip_writer_progress_cb cb,funcProgressCallbackzip func);
...
//#endif //MYAPPLICATION_MZ_ZIP_RW_H
